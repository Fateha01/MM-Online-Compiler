...
%token KW_INT KW_FLOAT KW_BOOL KW_STRING KW_IF KW_ELSE KW_WHILE KW_FOR COUT KW_TRUE KW_FALSE
%token ASSIGN SEMI LBRACE RBRACE LPAREN RPAREN COMMA
...
print_stmt:
    COUT SHL expr SEMI { $$ = ast_new_print($3, yylineno); }
    ;
